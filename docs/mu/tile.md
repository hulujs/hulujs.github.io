...
tile(obj: Record<string, any> | Record<string, any>[], chainType: PropPathType = 'dot');
```
...
通常配合 [mget](/mu/mget), [mgetx](/mu/mgetx), [mset](/mu/mset), [mset](/mu/mset), [mapping](/mu/mapping) 等一起使用, 会大大提高开发效率